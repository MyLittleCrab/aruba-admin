...
import { LoadBalancerIpAddresses } from "./LoadBalancerIpAddresses";
...
export interface LoadBalancer {
    ...
    LoadBalancerIPAddresses?: LoadBalancerIpAddresses;
    /** LoadBalancerRules */
    LoadBalancerRules?: LoadBalancerRules;
    /** LoadBalancerStatus|xs:string|Creating,Running,Stopped,Deleted */
